<template>
	<view>
		...
		<view class="foot" ><view><text  @tap="change">快速注册</text><text>忘记密码?</text></view></view>
	</view>
</template>
	...
	export default {
		...
		async submit(){
					...
					if(res.data.code==0){
						...
						// eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dpbiI6dHJ1ZSwiaWF0IjoxNTc1NTE5NDExfQ.NRPr6zr5Y8Q8UYcX8VTSrbDbofNY3wLUFVUd9Kvq1LM
						// userregister.vue:63 eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dpbiI6dHJ1ZSwiaWF0IjoxNTc1NTE5Mzc0fQ.a0gSrhIZt_QK5gLLpxHsbEz4AoRaAiS-jrWKX57IJeo
						uni.setStorage({
							key:'dsaddsad',
							data:{
								name:res.data.tel,
...
<style lang="scss" scoped>
	...
	.form{
		...
		.cuIcon-myfill,.cuIcon-backdelete{
			position:absolute;
			font-size: 50upx;
			top:18upx;
			color:#007AFF;
		...
		.cuIcon-backdelete,.cuIcon-attention{
			left:550upx;
		}
